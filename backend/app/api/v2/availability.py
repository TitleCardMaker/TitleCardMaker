...
from app.schemas.availability import (
    ReturnAvailableFontSchema,
    ReturnAvailableSeriesSchema,
    ReturnAvailableTemplateSchema,
    ReturnTranslationLanguageSchema,
)
...
def get_available_tmdb_translations() -> list[ReturnTranslationLanguageSchema]:
    """Get all supported translations from TMDb."""

    return [
        ReturnTranslationLanguageSchema(language_code=code, language=language)
...
def get_available_fonts_(
    ...
    ) -> list[ReturnAvailableFontSchema]:
