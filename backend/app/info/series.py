...
from re import IGNORECASE, match, compile as re_compile, sub as re_sub
...
class SeriesInfo(DatabaseInfoContainer):
    ...
    def filter_conditions(self,
        ...
        if self.tvdb_id and hasattr(SeriesModel, 'tvdb_id'):
...
class SeriesInfoV1(DatabaseInfoContainer):
    """
    ...
    @classmethod
    def from_jellyfin_info(cls, info: dict) -> 'SeriesInfoV1':
        """
        Create a SeriesInfo object from the given Jellyfin series data
        (from the `/Items/` endpoint).
    ...
    @staticmethod
    def from_plex_show(plex_show: PlexShow) -> 'SeriesInfoV1':
        """
        ...
        # Create SeriesInfo for this show
        series_info = SeriesInfoV1(plex_show.title, plex_show.year)
