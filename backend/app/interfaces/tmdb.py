...
class TMDbInterfaceV1(EpisodeDataSourceV1, WebInterface):
    """
    This class defines an interface to TheMovieDatabase (TMDb). Once
    initialized  with a valid API key, the primary purpose of this class
    ...
    def __update_blacklist(self,
            series_info: SeriesInfoV1,
            episode_info: EpisodeInfoV1 | None,
            query_type: str,
        ) -> None:
        """
    ...
    @catch_and_log('Error getting series logo', default=None)
    def get_series_logo(self, series_info: SeriesInfoV1) -> str | None:
        """
        Get the best logo for the given series.
    ...
    @staticmethod
    def unblacklist(series_info: SeriesInfoV1) -> None:
        """Remove all blacklist entries for the given series."""

        blacklist = PersistentDatabase(TMDbInterfaceV1.__BLACKLIST_DB)
    ...
    def delete_blacklist(database_directory: Path) -> None:
        ...
        database = database_directory / TMDbInterfaceV1.__BLACKLIST_DB
