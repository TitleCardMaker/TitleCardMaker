...
class JellyfinInterface(MediaServerV1, EpisodeDataSource, SyncInterface, Interface):
    """
    ...
    def __get_series_id(self,
        ...
        def _query_series(year: int) -> str | None:
            ...
            results: list[tuple[dict, SeriesInfoV1]] = [
                (result, SeriesInfoV1.from_jellyfin_info(
    ...
    def get_all_series(self,
        ...
        for library, library_id in self.libraries.items():
            ...
            for series in response['Items']:
                ...
                all_series.append((
                    SeriesInfoV1.from_jellyfin_info(
...
class JellyfinInterfaceV1(EpisodeDataSourceV1, MediaServerV1, SyncInterface):
    """
    This class describes an interface to a Jellyfin media server. This
    is a type of EpisodeDataSource (e.g. interface by which Episode data
    can be retrieved), as well as a MediaServer (e.g. a server in which
    ...
    def __get_series_id(self,
        ...
        def _query_series(year: int) -> str | None:
            ...
            # Parse all results into SeriesInfo objects
            results = [
                (result, SeriesInfoV1.from_jellyfin_info(result))
                for result in response['Items']
            ]
    ...
    def get_all_series(self,
        ...
        for library, library_id in self.libraries.items():
            ...
            for series in response['Items']:
                ...
                all_series.append((
                    SeriesInfoV1.from_jellyfin_info(series),
                    series['Path'],
                    library
                ))
