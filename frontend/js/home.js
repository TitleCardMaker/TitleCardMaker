...
function refreshCardData(seriesId) {
  $.ajax({
    type: 'GET',
    url: `/api/v2/series/series/${seriesId}`,
    success: series => {
...
function toggleMonitoredStatus(seriesId) {
  ...
  $.ajax({
    type: 'PUT',
    url: `/api/v2/series/series/${seriesId}/toggle-monitor`,
    success: series => {
...
function processSeries(seriesId) {
  ...
  $.ajax({
    type: 'POST',
    url: `/api/v2/series/series/${seriesId}/process`,
...
async function getAllSeries(page=undefined, keepSelection=false) {
  ...
  const includeCounts = window.localStorage.getItem('home:include-counts') === 'true' || false;
  const apiUrl = includeCounts ? '/api/v2/series/all-extended' : '/api/v2/series/all';
...
function batchChangeStatus(status) {
  ...
  $.ajax({
    type: 'PATCH',
    url: `/api/v2/series/batch/status/${status}`,
...
function batchProcess() {
  ...
  $.ajax({
    type: 'POST',
    url: '/api/v2/series/batch/process',
    data: JSON.stringify(selectedSeries),
    contentType: 'application/json',
    success: () => {
...
function batchLoad(reload=false) {
  ...
  $.ajax({
    type: 'PUT',
    url: `/api/v2/cards/batch/load?reload=${reload}`,
    data: JSON.stringify(selectedSeries),
    contentType: 'application/json',
...
function batchDeleteEpisodes() {
  ...
  $.ajax({
    type: 'DELETE',
    url: '/api/v2/episodes/batch/delete',
    data: JSON.stringify(selectedSeries),
    contentType: 'application/json',
    success: actions => {
...
function batchDeleteSeries() {
  ...
  $.ajax({
    type: 'DELETE',
    url: '/api/v2/series/batch/delete',
    data: JSON.stringify(selectedSeries),
    contentType: 'application/json',
    success: () => {
...
const filterChoices = {
  'string': [
    ...
    {name: 'text is longer than',  requiresInput: true},
    {name: 'text is shorter than', requiresInput: true},
  ],
  'nullable string': [
    {name: 'equals',               requiresInput: true },
    {name: 'does not equal',       requiresInput: true },
  ...
  'list': [
    ...
    {name: 'has more items than', requiresInput: true },
    {name: 'has less items than', requiresInput: true },
  ],
  'nullable list': [
    {name: 'is empty',            requiresInput: false},
    {name: 'is not empty',        requiresInput: false},
...
/**
 * Save current Import MediUX modal checkbox settings to localStorage.
 */
