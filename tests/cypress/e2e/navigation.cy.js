  ...
  const sidebarNavigation = [
    {
      ...
      navs: [
        ...
        { selector: '#nav-menu [href="/system"]',         name: 'system',        expectedUrl: '/system'         },
    ...
    },
    {
      ...
      navs: [
        ...
        { selector: '#nav-menu [href="/sync"]',           name: 'sync',      expectedUrl: '/sync'           },
        { selector: '#nav-menu [href="/settings"]',       name: 'settings',  expectedUrl: '/settings'       },
        { selector: '#nav-menu [href="/logs"]',           name: 'logs',      expectedUrl: '/logs'           },
        { selector: '#nav-menu [href="/import"]',         name: 'importer',  expectedUrl: '/import'         },
